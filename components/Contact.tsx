      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
          <motion.a
            ...
            className="flex items-center gap-4 p-5 rounded-2xl bg-white/4 border border-white/8 hover:border-blue-500/30 hover:bg-white/6 transition-all duration-200"
          ...
          >
            ...
            <div>
              <div className="text-white/40 text-xs mb-0.5">{t('email')}</div>
              <div className="text-white text-sm font-medium">{t('emailValue')}</div>
            </div>
          </motion.a>
          ...
          >
            ...
            <div>
              <div className="text-white/40 text-xs mb-0.5">{t('phone')}</div>
              <div className="text-white text-sm font-medium">{t('phoneValue')}</div>
            </div>
          </motion.a>
        </div>
        ...
        >
          <p className="text-white/40 text-sm mb-4">{t('followUs')}</p>
          <div className="flex items-center gap-2">
            {socialLinks.map((link) => (
              <a
                ...
                className="w-9 h-9 rounded-xl bg-white/4 border border-white/8 flex items-center justify-center text-white/50 hover:text-blue-400 hover:border-blue-500/30 hover:bg-white/6 transition-all duration-200"
              >
                {link.icon}
              </a>
            ))}
